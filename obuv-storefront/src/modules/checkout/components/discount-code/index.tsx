      ...
      <div className="txt-medium">
        {gift_cards.length > 0 && (
          <div className="flex flex-col mb-4">
            <Heading className="txt-medium">Ваш сертификат(ы) применен(ы):</Heading>
            {gift_cards?.map((gc) => (
              <div
              ...
              >
                ...
                >
                  <Trash size={14} />
                  <span className="sr-only">Удалить сертификат из заказа</span>
                </button>
              </div>
            ))}
          </div>
        ...
        {appliedDiscount ? (
          <div className="w-full flex items-center">
            <div className="flex flex-col w-full">
              <Heading className="txt-medium">Скидка применена:</Heading>
